...
00000215 g     F .text	00000074 avm_test_main
00000289 g     F .text	00000002 avm_halt
...
<avm_test_main>:
 ...
 d2 36                 brult8	avm_test_main+108
 f0 03 01              ldi8	r3, 0x1
 f1 72                 zext8	r2
 f4 b2                 dec16	r2
 f1 2a                 mov	r6, r2
 ...
 f4 b6                 dec16	r6
 f6 2e                 tst16	r6
 d0 df                 breq8	avm_test_main+46
 41                    ld8u	r4, [r5]
 f6 44                 sext8	r4
 ed ea 1f              ld8u	r7, [r5-1]
 f6 47                 sext8	r7
 33                    cmp	r4, r7
 d9 eb                 brsge8	avm_test_main+69
 57                    st8	[r5], r7
 ee 8a 1f              st8	[r5-1], r4
 f1 13                 mov	r2, r3
 f4 ab                 inc16	r3
 f4 ad                 inc16	r5
 f4 b6                 dec16	r6
 f6 2e                 tst16	r6
 d1 e5                 brne8	avm_test_main+79
 d4 c2                 jmp8	avm_test_main+46
 d7 01                 sys	debug_break
 a0                    xor	r4, r4
 b8                    pop16	r0
 b9                    pop16	r1
