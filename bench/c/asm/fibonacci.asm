...
0000023e g     F .text	0000000e avm_test_main
0000024c g     F .text	00000002 avm_halt
00000215 g     F .text	00000029 fib
00000100 g     O .data	00000002 f

Disassembly of section .text:

<_start>:
 d5 3c                 call8	avm_test_main
 c1 46                 ldi8	r5, 0x46
 c2 50                 ldi8	r6, 0x50
 f6 2c                 tst16	r4
 01                    mov	r4, r5
