...
00000216 g     F .text	000000d8 avm_test_main
000002ee g     F .text	00000002 avm_halt
...
<avm_test_main>:
 ...
 d1 a9                 brne8	avm_test_main+95
 f4 0b                 ldsp16	r7, [sp+0x2]
 f4 af                 inc16	r7
 0b                    mov	r6, r7
 f1 76                 zext8	r6
 ce 10                 cmpi.s8	r6, 0x10
 d1 97                 brne8	avm_test_main+88
