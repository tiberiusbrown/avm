...
00000316 g     F .text	0000010c avm_test_main
00000422 g     F .text	00000002 avm_halt
00000424 g     F .text	000000cf __avm_mulsi3
...
<avm_test_main>:
 ...
 d1 8c                 brne8	avm_test_main+124
 f4 01                 ldsp16	r5, [sp+0x0]
 f4 ad                 inc16	r5
 01                    mov	r4, r5
 f1 74                 zext8	r4
 cc 10                 cmpi.s8	r4, 0x10
 db 73 ff              brne16	avm_test_main+111
