...
00000316 g     F .text	000000d9 avm_test_main
000003ef g     F .text	00000002 avm_halt
...
<avm_test_main>:
 ...
 f4 b1                 dec16	r1
 f4 a1                 tst8	r1
 d1 cd                 brne8	avm_test_main+137
 f0 30 02              ldsp16	r0, [sp+0x2]
 f4 a8                 inc16	r0
 f1 24                 mov	r5, r0
 f1 75                 zext8	r5
 cd 20                 cmpi.s8	r5, 0x20
 d1 b6                 brne8	avm_test_main+127
 a2                    xor	r4, r6
 a3                    xor	r4, r7
