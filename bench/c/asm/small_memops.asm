...
00000216 g     F .text	000000d6 avm_test_main
000002ec g     F .text	00000002 avm_halt
...
<avm_test_main>:
 ...
 c7 24 01              ldi16	r7, 0x124
 f0 07 09 01           ldi16	r3, 0x109
 f0 05 0b 01           ldi16	r1, 0x10b
 ...
 f4 b1                 dec16	r1
 f6 29                 tst16	r1
 d1 f6                 brne8	avm_test_main+180
 f4 a8                 inc16	r0
 f1 20                 mov	r4, r0
 f1 74                 zext8	r4
 cc 40                 cmpi.s8	r4, 0x40
 d1 8d                 brne8	avm_test_main+85
