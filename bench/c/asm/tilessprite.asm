...
0000043f l     O .rodata	0000000a SPRITE
00000000 l    df *ABS*	00000000 runtime.c
00000200 g     F .text	00000016 _start
00000216 g     F .text	00000227 avm_test_main
0000043d g     F .text	00000002 avm_halt
