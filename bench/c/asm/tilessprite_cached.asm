...
0000043b l     O .rodata	0000000a SPRITE
00000000 l    df *ABS*	00000000 runtime.c
00000200 g     F .text	00000016 _start
00000216 g     F .text	00000223 avm_test_main
00000439 g     F .text	00000002 avm_halt
...
<_start>:
 ...
 e1 23 02              call16	avm_halt

<avm_test_main>:
 d7 01                 sys	debug_break
 c4 3b 04              ldi16	r4, 0x43b
 c1 00                 ldi8	r5, 0x0
