...
C:/tmp/avm-original-o2-root/build/bench/c/bubble1.elf:	file format elf32-avm
...
<avm_test_main>:
 ...
 f1 0d                 mov	r1, r5
 08                    mov	r6, r4
 d4 0a                 jmp8	avm_test_main+60
 f4 a9                 inc16	r1
 f4 af                 inc16	r7
 f4 b0                 dec16	r0
 f6 28                 tst16	r0
 d0 e1                 breq8	avm_test_main+29
 f5 3e                 ld8u	r2, [r7]
 f6 42                 sext8	r2
 ed 6e 1f              ld8u	r3, [r7-1]
 f6 43                 sext8	r3
 f5 13                 cmp	r2, r3
 d9 e9                 brsge8	avm_test_main+50
 f3 0f                 st8	[r7], r3
 ee 4e 1f              st8	[r7-1], r2
 f1 29                 mov	r6, r1
 d4 e0                 jmp8	avm_test_main+50
 d7 01                 sys	debug_break
 a0                    xor	r4, r4
 b8                    pop16	r0
 b9                    pop16	r1
