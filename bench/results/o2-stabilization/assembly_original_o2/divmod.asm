...
C:/tmp/avm-original-o2-root/build/bench/c/divmod.elf:	file format elf32-avm
...
00000216 g     F .text	00000158 avm_test_main
0000036e g     F .text	00000002 avm_halt
000004a0 g     F .text	00000014 __avm_udivsi3
00000370 g     F .text	000000ad __avm_mulsi3
0000041d g     F .text	00000083 __avm_udivmodsi4
...
<avm_test_main>:
 ...
 d1 c7                 brne8	avm_test_main+259
 f4 01                 ldsp16	r5, [sp+0x0]
 f4 ad                 inc16	r5
 01                    mov	r4, r5
 f1 74                 zext8	r4
 cc 04                 cmpi.s8	r4, 0x4
 db 70 ff              brne16	avm_test_main+184
