...
C:/tmp/avm-original-o2-root/build/bench/c/fir8.elf:	file format elf32-avm
...
<avm_test_main>:
 ...
 f4 b1                 dec16	r1
 f6 29                 tst16	r1
 d1 ec                 brne8	avm_test_main+102
 f2 27                 add	r5, r3
 f4 af                 inc16	r7
 cf 40                 cmpi.s8	r7, 0x40
 d1 d5                 brne8	avm_test_main+87
 f4 00                 ldsp16	r4, [sp+0x0]
 f4 ac                 inc16	r4
 08                    mov	r6, r4
 f1 76                 zext8	r6
 ce 10                 cmpi.s8	r6, 0x10
 d1 c7                 brne8	avm_test_main+84
 f0 5d 70 01           stm16	[0x170], r5
 d7 01                 sys	debug_break
 a0                    xor	r4, r4
 d6 02                 adjsp	avm_test_main+152
 b8                    pop16	r0
 b9                    pop16	r1
 ba                    pop16	r2
 bb                    pop16	r3
