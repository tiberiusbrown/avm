...
C:/tmp/avm-original-o2-root/build/bench/c/progmem_widen_ldp32_bytes.elf:	file format elf32-avm

SYMBOL TABLE:
00000000 l    df *ABS*	00000000 crt0_test.c
00000000 l    df *ABS*	00000000 progmem_widen_ldp32_bytes.c
000002e8 l     O .rodata	000000a0 program_bytes
0000024c l     F .text	0000009a sum_bytes
...
<sum_bytes>:
 ...
 d2 ab                 brult8	sum_bytes+25
 d4 05                 jmp8	sum_bytes+117
 0c                    mov	r7, r4
 ce 02                 cmpi.s8	r6, 0x2
 d2 a4                 brult8	sum_bytes+25
 ...
 f6 2a                 tst16	r2
 0c                    mov	r7, r4
 d1 e4                 brne8	sum_bytes+117
 d4 86                 jmp8	sum_bytes+25
