...
C:/tmp/avm-original-o2-root/build/bench/c/progmem_widen_ldp32_words.elf:	file format elf32-avm

SYMBOL TABLE:
00000000 l    df *ABS*	00000000 crt0_test.c
00000000 l    df *ABS*	00000000 progmem_widen_ldp32_words.c
000002ab l     O .rodata	000000a0 program_words
0000024c l     F .text	0000005d sum_words
00000100 l     O .data	00000006 results
00000000 l    df *ABS*	00000000 runtime.c
00000200 g     F .text	00000016 _start
00000216 g     F .text	00000036 avm_test_main
000002a9 g     F .text	00000002 avm_halt
...
<_start>:
 ...
 e1 93 00              call16	avm_halt

<avm_test_main>:
 b1                    push16	r1
 b0                    push16	r0
 d7 01                 sys	debug_break
 f0 04 ab 02           ldi16	r0, 0x2ab
