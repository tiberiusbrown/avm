...
C:/tmp/avm-original-o2-root/build/bench/c/shifts.elf:	file format elf32-avm
...
00000216 g     F .text	00000159 avm_test_main
0000036f g     F .text	00000002 avm_halt
00000371 g     F .text	00000024 __avm_ashlsi3
00000395 g     F .text	00000024 __avm_lshrsi3
...
<avm_test_main>:
 ...
 f7 54                 st16	[r7+], r4
 f2 21                 add	r4, r1
 f0 06 11 01           ldi16	r2, 0x111
 f2 13                 add	r2, r3
 f6 18                 st8	[r7+], r0
 f4 a8                 inc16	r0
 f0 07 33 22           ldi16	r3, 0x2233
 f5 13                 cmp	r2, r3
 d1 e6                 brne8	avm_test_main+29
 ...
 f4 b6                 dec16	r6
 f6 2e                 tst16	r6
 d1 c8                 brne8	avm_test_main+261
 f4 01                 ldsp16	r5, [sp+0x0]
 f4 ad                 inc16	r5
 01                    mov	r4, r5
 f1 74                 zext8	r4
 cc 08                 cmpi.s8	r4, 0x8
 db 66 ff              brne16	avm_test_main+175
