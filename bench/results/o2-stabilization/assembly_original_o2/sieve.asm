...
C:/tmp/avm-original-o2-root/build/bench/c/sieve.elf:	file format elf32-avm
...
00000515 g     F .text	00000049 avm_test_main
...
<avm_test_main>:
 ...
 d7 01                 sys	debug_break
 d4 09                 jmp8	avm_test_main+22
 19                    add	r6, r5
 c9 02                 addi.s8	r5, 0x2
 f4 ac                 inc16	r4
 cc 1e                 cmpi.s8	r4, 0x1e
 d0 2d                 breq8	avm_test_main+67
 ...
 f4 a0                 tst8	r0
 d1 e7                 brne8	avm_test_main+13
 f0 04 83 03           ldi16	r0, 0x383
 f5 07                 cmp	r0, r7
 d2 df                 brult8	avm_test_main+13
 f1 06                 mov	r0, r6
 ...
 f5 2d                 cmp	r7, r1
 d2 ef                 brult8	avm_test_main+48
 d4 ca                 jmp8	avm_test_main+13
 d7 01                 sys	debug_break
 a0                    xor	r4, r4
 b8                    pop16	r0
 b9                    pop16	r1
