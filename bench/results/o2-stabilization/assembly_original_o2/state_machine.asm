...
C:/tmp/avm-original-o2-root/build/bench/c/state_machine.elf:	file format elf32-avm
...
<avm_test_main>:
 ...
 01                    mov	r4, r5
 f1 0d                 mov	r1, r5
 d4 0b                 jmp8	avm_test_main+46
 f4 09                 ldsp16	r5, [sp+0x2]
 f4 ad                 inc16	r5
 09                    mov	r6, r5
 f1 76                 zext8	r6
 ce 40                 cmpi.s8	r6, 0x40
 d0 7b                 breq8	avm_test_main+169
 f4 49                 stsp16	[sp+0x2], r5
 c7 00 01              ldi16	r7, 0x100
 f0 30 00              ldsp16	r0, [sp+0x0]
 d4 13                 jmp8	avm_test_main+75
 06                    mov	r5, r6
 fa 85                 lsr16i	r5, 0x5
 ...
 f4 b0                 dec16	r0
 f6 28                 tst16	r0
 d0 d8                 breq8	avm_test_main+35
 f7 1e                 ld8u	r6, [r7+]
 f1 71                 zext8	r1
 f0 0d 02              cmpi.s8	r1, 0x2
 d9 1b                 brsge8	avm_test_main+111
 f4 a1                 tst8	r1
 d0 31                 breq8	avm_test_main+137
 f0 0d 01              cmpi.s8	r1, 0x1
 d1 db                 brne8	avm_test_main+56
 ...
 f0 0d 02              cmpi.s8	r1, 0x2
 d0 22                 breq8	avm_test_main+150
 f0 0d 03              cmpi.s8	r1, 0x3
 d1 bf                 brne8	avm_test_main+56
 ...
 10                    add	r4, r4
 92                    or	r4, r6
 d4 bc                 jmp8	avm_test_main+69
 12                    add	r4, r6
 f0 03 01              ldi8	r3, 0x1
 f9 78                 and	r3, r6
 f0 01 02              ldi8	r1, 0x2
 f2 3b                 sub	r1, r3
 d4 af                 jmp8	avm_test_main+69
