...
00000297 l     F .text	00000022 select_kernel
000001c0 l     O .data	00000002 select_result
00000000 l    df *ABS*	00000000 runtime.c
00000200 g     F .text	00000016 _start
00000216 g     F .text	00000081 avm_test_main
000002b9 g     F .text	00000002 avm_halt
...
<avm_test_main>:
 ...
 f4 b1                 dec16	r1
 f4 a1                 tst8	r1
 d1 ea                 brne8	avm_test_main+82
 f4 01                 ldsp16	r5, [sp+0x0]
 f4 ad                 inc16	r5
 01                    mov	r4, r5
 f1 74                 zext8	r4
 cc 10                 cmpi.s8	r4, 0x10
 d1 ce                 brne8	avm_test_main+65
 f0 5e c0 01           stm16	[0x1c0], r6
 d7 01                 sys	debug_break
 a0                    xor	r4, r4
 d6 04                 adjsp	avm_test_main+128
 b8                    pop16	r0
 b9                    pop16	r1
 ba                    pop16	r2
 bb                    pop16	r3
