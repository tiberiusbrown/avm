...
00000215 g     F .text	00000055 avm_test_main
0000026a g     F .text	00000002 avm_halt
...
<avm_test_main>:
 ...
 d2 28                 brult8	avm_test_main+77
 f1 1a                 mov	r3, r2
 c4 02 01              ldi16	r4, 0x102
 f1 11                 mov	r2, r1
 f1 28                 mov	r6, r0
 d4 0e                 jmp8	avm_test_main+62
 ...
 64                    ld16	r5, [r4]
 ed f8 1e              ld16	r7, [r4-2]
 37                    cmp	r5, r7
 d9 eb                 brsge8	avm_test_main+48
 73                    st16	[r4], r7
 ee b8 1e              st16	[r4-2], r5
 f1 16                 mov	r2, r6
 d4 e3                 jmp8	avm_test_main+48
 d7 01                 sys	debug_break
 a0                    xor	r4, r4
 b8                    pop16	r0
 b9                    pop16	r1
