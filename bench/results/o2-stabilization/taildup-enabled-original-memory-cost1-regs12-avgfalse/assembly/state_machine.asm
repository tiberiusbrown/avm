...
00000216 g     F .text	000000c7 avm_test_main
000002dd g     F .text	00000002 avm_halt
...
<avm_test_main>:
 ...
 f1 25                 mov	r5, r1
 d4 0b                 jmp8	avm_test_main+49
 f4 a9                 inc16	r1
 f1 29                 mov	r6, r1
 f1 76                 zext8	r6
 ce 40                 cmpi.s8	r6, 0x40
 da 83 00              breq16	avm_test_main+180
 f0 06 00 01           ldi16	r2, 0x100
 f1 28                 mov	r6, r0
 d4 15                 jmp8	avm_test_main+78
 03                    mov	r4, r7
 fa 75                 lsr16i	r4, 0x5
 c1 03                 ldi8	r5, 0x3
 84                    and	r5, r4
 ...
 f4 b6                 dec16	r6
 f6 2e                 tst16	r6
 d0 d8                 breq8	avm_test_main+38
 f0 6c e5              ld8u	r7, [r2+]
 f1 75                 zext8	r5
 cd 02                 cmpi.s8	r5, 0x2
 d9 19                 brsge8	avm_test_main+112
 f4 a5                 tst8	r5
 d0 35                 breq8	avm_test_main+144
 cd 01                 cmpi.s8	r5, 0x1
 d1 da                 brne8	avm_test_main+57
 c0 a0                 ldi8	r4, 0xa0
 a5                    xor	r5, r5
 ...
 f4 00                 ldsp16	r4, [sp+0x0]
 a3                    xor	r4, r7
 d4 d6                 jmp8	avm_test_main+70
 cd 02                 cmpi.s8	r5, 0x2
 d0 2f                 breq8	avm_test_main+163
 cd 03                 cmpi.s8	r5, 0x3
 d1 c1                 brne8	avm_test_main+57
 c1 04                 ldi8	r5, 0x4
 a0                    xor	r4, r4
 f4 a7                 tst8	r7
 fb 2c                 cmov.eq	r5, r4
 ...
 f4 b6                 dec16	r6
 f6 2e                 tst16	r6
 d1 c0                 brne8	avm_test_main+78
 d4 96                 jmp8	avm_test_main+38
 f4 00                 ldsp16	r4, [sp+0x0]
 13                    add	r4, r7
 f4 40                 stsp16	[sp+0x0], r4
 c0 01                 ldi8	r4, 0x1
 ...
 f4 b6                 dec16	r6
 f6 2e                 tst16	r6
 d1 ad                 brne8	avm_test_main+78
 d4 83                 jmp8	avm_test_main+38
 c0 30                 ldi8	r4, 0x30
 83                    and	r4, r7
 c1 01                 ldi8	r5, 0x1
