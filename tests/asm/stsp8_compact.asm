...
.Lstsp8_000_SGE_done:
    ...
    ; STACK64 entry 0x01: stsp8 [sp+0], c1.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0700
...
.Lstsp8_001_SGE_done:
    ...
    ; STACK64 entry 0x02: stsp8 [sp+0], c2.
    ldi16 c2, 0x1357
    ldi16 c3, 0x1357
    cmp c2, c3
    ldi16 c0, 0x0700
...
.Lstsp8_002_SGE_done:
    ...
    ; STACK64 entry 0x03: stsp8 [sp+0], c3.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0700
...
.Lstsp8_004_SGE_done:
    ...
    ; STACK64 entry 0x05: stsp8 [sp+1], c1.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0701
...
.Lstsp8_005_SGE_done:
    ...
    ; STACK64 entry 0x06: stsp8 [sp+1], c2.
    ldi16 c2, 0x1357
    ldi16 c3, 0x1357
    cmp c2, c3
    ldi16 c0, 0x0701
...
.Lstsp8_006_SGE_done:
    ...
    ; STACK64 entry 0x07: stsp8 [sp+1], c3.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0701
...
.Lstsp8_008_SGE_done:
    ...
    ; STACK64 entry 0x09: stsp8 [sp+2], c1.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0702
...
.Lstsp8_009_SGE_done:
    ...
    ; STACK64 entry 0x0A: stsp8 [sp+2], c2.
    ldi16 c2, 0x1357
    ldi16 c3, 0x1357
    cmp c2, c3
    ldi16 c0, 0x0702
...
.Lstsp8_00a_SGE_done:
    ...
    ; STACK64 entry 0x0B: stsp8 [sp+2], c3.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0702
...
.Lstsp8_00c_SGE_done:
    ...
    ; STACK64 entry 0x0D: stsp8 [sp+3], c1.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0703
...
.Lstsp8_00d_SGE_done:
    ...
    ; STACK64 entry 0x0E: stsp8 [sp+3], c2.
    ldi16 c2, 0x1357
    ldi16 c3, 0x1357
    cmp c2, c3
    ldi16 c0, 0x0703
...
.Lstsp8_00e_SGE_done:
    ...
    ; STACK64 entry 0x0F: stsp8 [sp+3], c3.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0703
...
.Lstsp8_010_SGE_done:
    ...
    ; STACK64 entry 0x11: stsp8 [sp+4], c1.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0704
...
.Lstsp8_011_SGE_done:
    ...
    ; STACK64 entry 0x12: stsp8 [sp+4], c2.
    ldi16 c2, 0x1357
    ldi16 c3, 0x1357
    cmp c2, c3
    ldi16 c0, 0x0704
...
.Lstsp8_012_SGE_done:
    ...
    ; STACK64 entry 0x13: stsp8 [sp+4], c3.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0704
...
.Lstsp8_014_SGE_done:
    ...
    ; STACK64 entry 0x15: stsp8 [sp+5], c1.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0705
...
.Lstsp8_015_SGE_done:
    ...
    ; STACK64 entry 0x16: stsp8 [sp+5], c2.
    ldi16 c2, 0x1357
    ldi16 c3, 0x1357
    cmp c2, c3
    ldi16 c0, 0x0705
...
.Lstsp8_016_SGE_done:
    ...
    ; STACK64 entry 0x17: stsp8 [sp+5], c3.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0705
...
.Lstsp8_018_SGE_done:
    ...
    ; STACK64 entry 0x19: stsp8 [sp+6], c1.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0706
...
.Lstsp8_019_SGE_done:
    ...
    ; STACK64 entry 0x1A: stsp8 [sp+6], c2.
    ldi16 c2, 0x1357
    ldi16 c3, 0x1357
    cmp c2, c3
    ldi16 c0, 0x0706
...
.Lstsp8_01a_SGE_done:
    ...
    ; STACK64 entry 0x1B: stsp8 [sp+6], c3.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0706
...
.Lstsp8_01c_SGE_done:
    ...
    ; STACK64 entry 0x1D: stsp8 [sp+7], c1.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0707
...
.Lstsp8_01d_SGE_done:
    ...
    ; STACK64 entry 0x1E: stsp8 [sp+7], c2.
    ldi16 c2, 0x1357
    ldi16 c3, 0x1357
    cmp c2, c3
    ldi16 c0, 0x0707
...
.Lstsp8_01e_SGE_done:
    ...
    ; STACK64 entry 0x1F: stsp8 [sp+7], c3.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0707
...
.Lstsp8_020_SGE_done:
    ...
    ; STACK64 entry 0x21: stsp8 [sp+8], c1.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0708
...
.Lstsp8_021_SGE_done:
    ...
    ; STACK64 entry 0x22: stsp8 [sp+8], c2.
    ldi16 c2, 0x1357
    ldi16 c3, 0x1357
    cmp c2, c3
    ldi16 c0, 0x0708
...
.Lstsp8_022_SGE_done:
    ...
    ; STACK64 entry 0x23: stsp8 [sp+8], c3.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0708
...
.Lstsp8_024_SGE_done:
    ...
    ; STACK64 entry 0x25: stsp8 [sp+9], c1.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0709
...
.Lstsp8_025_SGE_done:
    ...
    ; STACK64 entry 0x26: stsp8 [sp+9], c2.
    ldi16 c2, 0x1357
    ldi16 c3, 0x1357
    cmp c2, c3
    ldi16 c0, 0x0709
...
.Lstsp8_026_SGE_done:
    ...
    ; STACK64 entry 0x27: stsp8 [sp+9], c3.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x0709
...
.Lstsp8_028_SGE_done:
    ...
    ; STACK64 entry 0x29: stsp8 [sp+10], c1.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x070a
...
.Lstsp8_029_SGE_done:
    ...
    ; STACK64 entry 0x2A: stsp8 [sp+10], c2.
    ldi16 c2, 0x1357
    ldi16 c3, 0x1357
    cmp c2, c3
    ldi16 c0, 0x070a
...
.Lstsp8_02a_SGE_done:
    ...
    ; STACK64 entry 0x2B: stsp8 [sp+10], c3.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x070a
...
.Lstsp8_02c_SGE_done:
    ...
    ; STACK64 entry 0x2D: stsp8 [sp+11], c1.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x070b
...
.Lstsp8_02d_SGE_done:
    ...
    ; STACK64 entry 0x2E: stsp8 [sp+11], c2.
    ldi16 c2, 0x1357
    ldi16 c3, 0x1357
    cmp c2, c3
    ldi16 c0, 0x070b
...
.Lstsp8_02e_SGE_done:
    ...
    ; STACK64 entry 0x2F: stsp8 [sp+11], c3.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x070b
...
.Lstsp8_030_SGE_done:
    ...
    ; STACK64 entry 0x31: stsp8 [sp+12], c1.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x070c
...
.Lstsp8_031_SGE_done:
    ...
    ; STACK64 entry 0x32: stsp8 [sp+12], c2.
    ldi16 c2, 0x1357
    ldi16 c3, 0x1357
    cmp c2, c3
    ldi16 c0, 0x070c
...
.Lstsp8_032_SGE_done:
    ...
    ; STACK64 entry 0x33: stsp8 [sp+12], c3.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x070c
...
.Lstsp8_034_SGE_done:
    ...
    ; STACK64 entry 0x35: stsp8 [sp+13], c1.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x070d
...
.Lstsp8_035_SGE_done:
    ...
    ; STACK64 entry 0x36: stsp8 [sp+13], c2.
    ldi16 c2, 0x1357
    ldi16 c3, 0x1357
    cmp c2, c3
    ldi16 c0, 0x070d
...
.Lstsp8_036_SGE_done:
    ...
    ; STACK64 entry 0x37: stsp8 [sp+13], c3.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x070d
...
.Lstsp8_038_SGE_done:
    ...
    ; STACK64 entry 0x39: stsp8 [sp+14], c1.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x070e
...
.Lstsp8_039_SGE_done:
    ...
    ; STACK64 entry 0x3A: stsp8 [sp+14], c2.
    ldi16 c2, 0x1357
    ldi16 c3, 0x1357
    cmp c2, c3
    ldi16 c0, 0x070e
...
.Lstsp8_03a_SGE_done:
    ...
    ; STACK64 entry 0x3B: stsp8 [sp+14], c3.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x070e
...
.Lstsp8_03c_SGE_done:
    ...
    ; STACK64 entry 0x3D: stsp8 [sp+15], c1.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x070f
...
.Lstsp8_03d_SGE_done:
    ...
    ; STACK64 entry 0x3E: stsp8 [sp+15], c2.
    ldi16 c2, 0x1357
    ldi16 c3, 0x1357
    cmp c2, c3
    ldi16 c0, 0x070f
...
.Lstsp8_03e_SGE_done:
    ...
    ; STACK64 entry 0x3F: stsp8 [sp+15], c3.
    ldi16 c2, 0x8000
    ldi16 c3, 0x7fff
    cmp c2, c3
    ldi16 c0, 0x070f
