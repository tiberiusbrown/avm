...
000002a9 l     F .text	00000002 add_values
0000029f l     F .text	0000000a call_indirect
000002ab l     F .text	00000009 xor_values
0000029a l     F .text	00000005 many_arguments
00000000 l    df *ABS*	00000000 runtime.c
00000100 g     F .text	00000016 _start
00000116 g     F .text	00000184 avm_test_main
000002b4 g     F .text	00000002 avm_halt
...
<_start>:
 ...
 e1 9e 01              call16	avm_halt

<avm_test_main>:
 b2                    push16	r2
 b1                    push16	r1
 b0                    push16	r0
 d6 ea                 adjsp	_start+5
 c0 01                 ldi8	r4, 0x1
 ...
 e1 6c 01              call16	call_indirect
 f1 04                 mov	r0, r4
 c4 ab 02              ldi16	r4, 0x2ab
 c1 00                 ldi8	r5, 0x0
 f1 75                 zext8	r5
 c6 cd ab              ldi16	r6, 0xabcd
 c7 0f 0f              ldi16	r7, 0xf0f
 e1 5a 01              call16	call_indirect
 ...
 d7 00                 sys	debug_putc
 f1 21                 mov	r4, r1
 e1 40 01              call16	many_arguments
 08                    mov	r6, r4
 f1 74                 zext8	r4
 0c                    mov	r7, r4
 fa a4                 lsr16i	r7, 0x4
