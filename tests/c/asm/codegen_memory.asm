...
00000541 l     F .text	00000027 hash_bytes
00000568 l     F .text	00000027 update_record
0000058f l     F .text	0000000a read_neighbors
00000599 l     F .text	000000ee walk_both_directions
00000000 l    df *ABS*	00000000 runtime.c
00000200 g     F .text	00000016 _start
00000216 g     F .text	0000032b avm_test_main
00000687 g     F .text	00000002 avm_halt
...
<avm_test_main>:
 ...
 e1 9e 02              call16	read_neighbors
 ...
 f1 20                 mov	r4, r0
 e1 8e 02              call16	walk_both_directions
 ...
 d7 00                 sys	debug_putc
 f1 20                 mov	r4, r0
 d6 67                 adjsp	walk_both_directions+10
 b8                    pop16	r0
 b9                    pop16	r1
 ba                    pop16	r2
 bb                    pop16	r3
