...
000006fc l     O .rodata	00000060 program_bytes
000004da l     F .text	00000086 sum_bytes
00000560 l     F .text	000000b7 sum_signed_bytes
00000617 l     F .text	00000047 mix_bytes
0000065e l     F .text	00000052 sum_byte_pairs
0000075c l     O .rodata	00000050 program_words
000006b0 l     F .text	0000004a sum_words
00000000 l    df *ABS*	00000000 runtime.c
00000100 g     F .text	00000016 _start
00000116 g     F .text	000003c4 avm_test_main
000006fa g     F .text	00000002 avm_halt
...
<avm_test_main>:
 ...
 c4 5e 07              ldi16	r4, 0x75e
 c1 00                 ldi8	r5, 0x0
 f1 75                 zext8	r5
 f0 36 46              ldsp16	r6, [sp+0x46]
 e1 a5 04              call16	sum_words
