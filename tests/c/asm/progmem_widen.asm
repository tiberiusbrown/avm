...
0000070d l     O .rodata	00000060 program_bytes
000004eb l     F .text	00000087 sum_bytes
00000572 l     F .text	000000b6 sum_signed_bytes
00000628 l     F .text	00000047 mix_bytes
0000066f l     F .text	00000052 sum_byte_pairs
0000076d l     O .rodata	00000050 program_words
000006c1 l     F .text	0000004a sum_words
00000000 l    df *ABS*	00000000 runtime.c
00000100 g     F .text	00000016 _start
00000116 g     F .text	000003d5 avm_test_main
0000070b g     F .text	00000002 avm_halt
...
<avm_test_main>:
 ...
 c4 0d 07              ldi16	r4, 0x70d
 c1 00                 ldi8	r5, 0x0
 f1 75                 zext8	r5
 f0 36 52              ldsp16	r6, [sp+0x52]
 e1 9f 03              call16	sum_bytes
 ...
 c4 0e 07              ldi16	r4, 0x70e
 c1 00                 ldi8	r5, 0x0
 f1 75                 zext8	r5
 f0 36 50              ldsp16	r6, [sp+0x50]
 e1 77 03              call16	sum_bytes
 ...
 c4 6f 07              ldi16	r4, 0x76f
 c1 00                 ldi8	r5, 0x0
 f1 75                 zext8	r5
 f0 36 46              ldsp16	r6, [sp+0x46]
 e1 b2 04              call16	sum_words
