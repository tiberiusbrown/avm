...
C:/Users/Brown/Documents/GitHub/avm/build/tests/c/sprite_cached_plus_mask.elf:	file format elf32-avm

SYMBOL TABLE:
00000000 l    df *ABS*	00000000 crt0_test.c
00000000 l    df *ABS*	00000000 sprite_cached_plus_mask.c
00000993 l     O .rodata	0000003e sprite_a
00000460 l     F .text	0000010f compare_one
0000056f l     F .text	0000010d test_repeated_draws_one_binding
0000067c l     F .text	00000157 test_rebinding
000007d3 l     F .text	00000149 test_explicit_draw_does_not_rebind
000009d1 l     O .rodata	00000002 sprite_zero_width
0000091c l     F .text	00000075 test_zero_dimension
000009d3 l     O .rodata	00000002 sprite_zero_height
000009d5 l     O .rodata	00000026 sprite_b
00000000 l    df *ABS*	00000000 runtime.c
00000100 g     F .text	00000016 _start
00000116 g     F .text	0000034a avm_test_main
...
<avm_test_main>:
 ...
 f1 28                 mov	r6, r0
 d7 11                 sys	memset
 c4 93 09              ldi16	r4, 0x993
 c1 00                 ldi8	r5, 0x0
 d7 22                 sys	set_sprite
 43                    ld8u	r4, [r7]
 f5 21                 cmp	r4, r1
 db 57 02              brne16	avm_test_main+635
 f4 af                 inc16	r7
 f4 b0                 dec16	r0
 f6 28                 tst16	r0
 ...
 f5 08                 cmp	r1, r0
 d1 e1                 brne8	avm_test_main+174
 f4 00                 ldsp16	r4, [sp+0x0]
 31                    cmp	r4, r5
 f4 08                 ldsp16	r4, [sp+0x2]
 db c8 01              brne16	avm_test_main+669
 33                    cmp	r4, r7
 db c4 01              brne16	avm_test_main+669
 c1 a5                 ldi8	r5, 0xa5
 f0 05 00 05           ldi16	r1, 0x500
 f1 21                 mov	r4, r1
 c6 00 04              ldi16	r6, 0x400
 ...
 f0 09 02              addi.s8	r1, 0x2
 f5 08                 cmp	r1, r0
 d1 e1                 brne8	avm_test_main+328
 f4 00                 ldsp16	r4, [sp+0x0]
 31                    cmp	r4, r5
 f4 08                 ldsp16	r4, [sp+0x2]
 db 5b 01              brne16	avm_test_main+714
 33                    cmp	r4, r7
 db 57 01              brne16	avm_test_main+714
 c1 3c                 ldi8	r5, 0x3c
 f0 05 00 05           ldi16	r1, 0x500
 f1 21                 mov	r4, r1
 c6 00 04              ldi16	r6, 0x400
 ...
 f5 10                 cmp	r2, r0
 d1 e1                 brne8	avm_test_main+482
 f4 01                 ldsp16	r5, [sp+0x0]
 34                    cmp	r5, r4
 f4 08                 ldsp16	r4, [sp+0x2]
 db e9 00              brne16	avm_test_main+754
 33                    cmp	r4, r7
 db e5 00              brne16	avm_test_main+754
 d6 fb                 adjsp	-0x5
 c4 93 09              ldi16	r4, 0x993
 c1 00                 ldi8	r5, 0x0
 ...
 e1 1f 01              call16	compare_one
 d6 05                 adjsp	0x5
 f4 a4                 tst8	r4
 d1 46                 brne8	avm_test_main+631
 d6 fb                 adjsp	-0x5
 c0 02                 ldi8	r4, 0x2
 f4 4c                 stsp16	[sp+0x3], r4
 c4 93 09              ldi16	r4, 0x993
 ...
 d6 05                 adjsp	0x5
 f4 a4                 tst8	r4
 d1 26                 brne8	avm_test_main+631
 e1 05 02              call16	test_repeated_draws_one_binding
 f4 a4                 tst8	r4
 d1 1f                 brne8	avm_test_main+631
 e1 0b 03              call16	test_rebinding
 f4 a4                 tst8	r4
 d1 18                 brne8	avm_test_main+631
 e1 5b 04              call16	test_explicit_draw_does_not_rebind
 f4 a4                 tst8	r4
 d1 11                 brne8	avm_test_main+631
 c6 d1 09              ldi16	r6, 0x9d1
 c3 00                 ldi8	r7, 0x0
 f1 77                 zext8	r7
 c0 09                 ldi8	r4, 0x9
 e1 94 05              call16	test_zero_dimension
 f4 a4                 tst8	r4
 da a3 00              breq16	avm_test_main+794
 f1 20                 mov	r4, r0
 d4 48                 jmp8	avm_test_main+707
 c0 43                 ldi8	r4, 0x43
 d7 00                 sys	debug_putc
 c0 41                 ldi8	r4, 0x41
 d7 00                 sys	debug_putc
 ...
 d7 00                 sys	debug_putc
 c0 01                 ldi8	r4, 0x1
 d4 a9                 jmp8	avm_test_main+707
 c6 d3 09              ldi16	r6, 0x9d3
 c3 00                 ldi8	r7, 0x0
 f1 77                 zext8	r7
 c0 0a                 ldi8	r4, 0xa
 e1 e0 04              call16	test_zero_dimension
 f4 a4                 tst8	r4
 f1 20                 mov	r4, r0
 d1 97                 brne8	avm_test_main+707
 d6 fb                 adjsp	-0x5
 c0 01                 ldi8	r4, 0x1
 f4 4c                 stsp16	[sp+0x3], r4
 c4 d5 09              ldi16	r4, 0x9d5
 c1 00                 ldi8	r5, 0x0
 f4 40                 stsp16	[sp+0x0], r4
 f1 39                 stsp8	[sp+0x2], r5
 c0 0b                 ldi8	r4, 0xb
 ...
 d6 05                 adjsp	0x5
 e0 79 ff              jmp16	avm_test_main+707
...
<test_repeated_draws_one_binding>:
 ...
 c5 00 08              ldi16	r5, 0x800
 f5 05                 cmp	r0, r5
 d1 de                 brne8	test_repeated_draws_one_binding+86
 f4 42                 stsp16	[sp+0x0], r6
 f4 48                 stsp16	[sp+0x2], r4
 f1 05                 mov	r0, r5
 c4 93 09              ldi16	r4, 0x993
 ...
 f0 0a 02              addi.s8	r2, 0x2
 f5 10                 cmp	r2, r0
 d1 e1                 brne8	test_repeated_draws_one_binding+180
 f4 00                 ldsp16	r4, [sp+0x0]
 33                    cmp	r4, r7
 f4 08                 ldsp16	r4, [sp+0x2]
...
<test_rebinding>:
 ...
 f5 06                 cmp	r0, r6
 d1 ca                 brne8	test_rebinding+120
 ...
 f0 0a 02              addi.s8	r2, 0x2
 f5 10                 cmp	r2, r0
 d1 e1                 brne8	test_rebinding+254
 f4 20                 ldsp16	r4, [sp+0x8]
 32                    cmp	r4, r6
 f4 10                 ldsp16	r4, [sp+0x4]
 d1 06                 brne8	test_rebinding+298
 33                    cmp	r4, r7
 d1 03                 brne8	test_rebinding+298
 a0                    xor	r4, r4
 d4 26                 jmp8	test_rebinding+336
 c0 43                 ldi8	r4, 0x43
 d7 00                 sys	debug_putc
 c0 41                 ldi8	r4, 0x41
 d7 00                 sys	debug_putc
...
<test_explicit_draw_does_not_rebind>:
 ...
 c6 00 08              ldi16	r6, 0x800
 f5 0e                 cmp	r1, r6
 d1 db                 brne8	test_explicit_draw_does_not_rebind+117
 f4 51                 stsp16	[sp+0x4], r5
 f4 60                 stsp16	[sp+0x8], r4
 c7 00 05              ldi16	r7, 0x500
 03                    mov	r4, r7
...
<test_zero_dimension>:
 ...
 d1 0a                 brne8	test_zero_dimension+58
 f4 af                 inc16	r7
 f4 b2                 dec16	r2
 f6 2a                 tst16	r2
 d1 f3                 brne8	test_zero_dimension+43
 d4 34                 jmp8	test_zero_dimension+110
 c2 30                 ldi8	r6, 0x30
 f1 20                 mov	r4, r0
 92                    or	r4, r6
 f1 24                 mov	r5, r0
