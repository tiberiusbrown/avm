...
00000922 l     O .rodata	00000020 sprite_5x13
000068ba l     O .rodata	00000400 expected_00
00000942 l     O .rodata	00000400 expected_01
00000d42 l     O .rodata	00000400 expected_02
00001142 l     O .rodata	00000400 expected_03
00001542 l     O .rodata	00000400 expected_04
00001942 l     O .rodata	00000400 expected_05
00001d42 l     O .rodata	00000400 expected_06
00002142 l     O .rodata	00000104 sprite_1x1_many_frames
00002246 l     O .rodata	00000400 expected_07
00002646 l     O .rodata	0000000b sprite_9x8
00002651 l     O .rodata	00000400 expected_08
00002a51 l     O .rodata	00000400 expected_09
00002e51 l     O .rodata	0000001a sprite_4x17
00002e6b l     O .rodata	00000400 expected_10
0000326b l     O .rodata	00000400 expected_11
0000366b l     O .rodata	0000020a sprite_130x9
00003875 l     O .rodata	00000400 expected_12
00003c75 l     O .rodata	00000041 sprite_7x65
00003cb6 l     O .rodata	00000400 expected_13
000040b6 l     O .rodata	00000400 expected_14
000044b6 l     O .rodata	00000400 expected_15
000048b6 l     O .rodata	00000400 expected_16
00004cb6 l     O .rodata	00000400 expected_17
000050b6 l     O .rodata	00000002 sprite_zero_width
000050b8 l     O .rodata	00000400 expected_18
000054b8 l     O .rodata	00000002 sprite_zero_height
000054ba l     O .rodata	00000400 expected_19
000058ba l     O .rodata	00000400 expected_20
00005cba l     O .rodata	00000400 expected_21
000060ba l     O .rodata	00000400 expected_22
000064ba l     O .rodata	00000400 expected_23
...
<avm_test_main>:
 ...
 c6 42 21              ldi16	r6, 0x2142
 c3 00                 ldi8	r7, 0x0
 c1 3f                 ldi8	r5, 0x3f
 c0 7f                 ldi8	r4, 0x7f
 f0 30 00              ldsp16	r0, [sp+0x0]
 d7 1e                 sys	draw_sprite_overwrite
 c6 46 22              ldi16	r6, 0x2246
 c3 00                 ldi8	r7, 0x0
 f1 77                 zext8	r7
 f1 21                 mov	r4, r1
 f1 27                 mov	r5, r3
 ...
 c1 69                 ldi8	r5, 0x69
 d7 11                 sys	memset
 c6 51 2e              ldi16	r6, 0x2e51
 c3 00                 ldi8	r7, 0x0
 c5 f7 ff              ldi16	r5, 0xfff7
 c0 14                 ldi8	r4, 0x14
 d7 1e                 sys	draw_sprite_overwrite
 c6 6b 2e              ldi16	r6, 0x2e6b
 c3 00                 ldi8	r7, 0x0
 f1 77                 zext8	r7
 f1 23                 mov	r4, r3
 f1 25                 mov	r5, r1
 ...
 c1 5a                 ldi8	r5, 0x5a
 d7 11                 sys	memset
 c6 6b 36              ldi16	r6, 0x366b
 c3 00                 ldi8	r7, 0x0
 c1 1f                 ldi8	r5, 0x1f
 f0 07 ff ff           ldi16	r3, 0xffff
 f1 23                 mov	r4, r3
 d7 1e                 sys	draw_sprite_overwrite
 c6 75 38              ldi16	r6, 0x3875
 c3 00                 ldi8	r7, 0x0
 f1 77                 zext8	r7
 f1 22                 mov	r4, r2
 f1 25                 mov	r5, r1
 ...
 c1 a5                 ldi8	r5, 0xa5
 d7 11                 sys	memset
 c6 75 3c              ldi16	r6, 0x3c75
 c3 00                 ldi8	r7, 0x0
 c0 3c                 ldi8	r4, 0x3c
 f1 27                 mov	r5, r3
 d7 1e                 sys	draw_sprite_overwrite
 c6 b6 3c              ldi16	r6, 0x3cb6
 c3 00                 ldi8	r7, 0x0
 f1 77                 zext8	r7
 f1 22                 mov	r4, r2
 f1 25                 mov	r5, r1
 ...
 f0 38 00              stsp16	[sp+0x0], r0
 c6 b6 50              ldi16	r6, 0x50b6
 c3 00                 ldi8	r7, 0x0
 f1 21                 mov	r4, r1
 f1 25                 mov	r5, r1
 f0 30 00              ldsp16	r0, [sp+0x0]
 d7 1e                 sys	draw_sprite_overwrite
 c6 b8 50              ldi16	r6, 0x50b8
 c3 00                 ldi8	r7, 0x0
 f1 77                 zext8	r7
 f1 22                 mov	r4, r2
 f1 27                 mov	r5, r3
 ...
 f0 38 00              stsp16	[sp+0x0], r0
 c6 b8 54              ldi16	r6, 0x54b8
 c3 00                 ldi8	r7, 0x0
 f1 21                 mov	r4, r1
 f1 25                 mov	r5, r1
 f0 30 00              ldsp16	r0, [sp+0x0]
 d7 1e                 sys	draw_sprite_overwrite
 c6 ba 54              ldi16	r6, 0x54ba
 c3 00                 ldi8	r7, 0x0
 f1 77                 zext8	r7
 f1 22                 mov	r4, r2
 f1 27                 mov	r5, r3
