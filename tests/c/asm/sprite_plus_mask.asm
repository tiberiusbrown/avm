...
000008fe l     O .rodata	0000003e sprite_5x13
00006c1e l     O .rodata	00000400 expected_00
0000093c l     O .rodata	00000400 expected_01
00000d3c l     O .rodata	00000400 expected_02
0000113c l     O .rodata	00000400 expected_03
0000153c l     O .rodata	00000400 expected_04
0000193c l     O .rodata	00000400 expected_05
00001d3c l     O .rodata	00000400 expected_06
0000213c l     O .rodata	00000206 sprite_1x1_many_frames
00002342 l     O .rodata	00000400 expected_07
00002742 l     O .rodata	00000014 sprite_9x8
00002756 l     O .rodata	00000400 expected_08
00002b56 l     O .rodata	00000400 expected_09
00002f56 l     O .rodata	00000032 sprite_4x17
00002f88 l     O .rodata	00000400 expected_10
00003388 l     O .rodata	00000400 expected_11
00003788 l     O .rodata	00000412 sprite_130x9
00003b9a l     O .rodata	00000400 expected_12
00003f9a l     O .rodata	00000080 sprite_7x65
0000401a l     O .rodata	00000400 expected_13
0000441a l     O .rodata	00000400 expected_14
0000481a l     O .rodata	00000400 expected_15
00004c1a l     O .rodata	00000400 expected_16
0000501a l     O .rodata	00000400 expected_17
0000541a l     O .rodata	00000002 sprite_zero_width
0000541c l     O .rodata	00000400 expected_18
0000581c l     O .rodata	00000002 sprite_zero_height
0000581e l     O .rodata	00000400 expected_19
00005c1e l     O .rodata	00000400 expected_20
0000601e l     O .rodata	00000400 expected_21
0000641e l     O .rodata	00000400 expected_22
0000681e l     O .rodata	00000400 expected_23
...
<avm_test_main>:
 ...
 c1 3c                 ldi8	r5, 0x3c
 d7 11                 sys	memset
 f0 06 42 27           ldi16	r2, 0x2742
 f0 03 00              ldi8	r3, 0x0
 c1 07                 ldi8	r5, 0x7
 c4 fc ff              ldi16	r4, 0xfffc
 0b                    mov	r6, r7
 d7 1f                 sys	draw_sprite_plus_mask
 c6 56 27              ldi16	r6, 0x2756
 c3 00                 ldi8	r7, 0x0
 f1 77                 zext8	r7
 f1 21                 mov	r4, r1
 f1 24                 mov	r5, r0
 ...
 c1 69                 ldi8	r5, 0x69
 d7 11                 sys	memset
 f0 06 56 2f           ldi16	r2, 0x2f56
 f0 03 00              ldi8	r3, 0x0
 c5 f7 ff              ldi16	r5, 0xfff7
 c0 14                 ldi8	r4, 0x14
 0b                    mov	r6, r7
 d7 1f                 sys	draw_sprite_plus_mask
 c6 88 2f              ldi16	r6, 0x2f88
 c3 00                 ldi8	r7, 0x0
 f1 77                 zext8	r7
 f1 21                 mov	r4, r1
 f1 24                 mov	r5, r0
 ...
 c1 a5                 ldi8	r5, 0xa5
 d7 11                 sys	memset
 f0 06 9a 3f           ldi16	r2, 0x3f9a
 f0 03 00              ldi8	r3, 0x0
 c0 3c                 ldi8	r4, 0x3c
 c5 ff ff              ldi16	r5, 0xffff
 0b                    mov	r6, r7
 d7 1f                 sys	draw_sprite_plus_mask
 c6 1a 40              ldi16	r6, 0x401a
 c3 00                 ldi8	r7, 0x0
 f1 77                 zext8	r7
 f1 21                 mov	r4, r1
 f1 24                 mov	r5, r0
 ...
 f0 06 1c 58           ldi16	r2, 0x581c
 f0 03 00              ldi8	r3, 0x0
 03                    mov	r4, r7
 07                    mov	r5, r7
 d7 1f                 sys	draw_sprite_plus_mask
 c6 1e 58              ldi16	r6, 0x581e
 c3 00                 ldi8	r7, 0x0
 f1 77                 zext8	r7
 f1 21                 mov	r4, r1
 f1 24                 mov	r5, r0
 ...
 f1 21                 mov	r4, r1
 d7 11                 sys	memset
 f0 06 88 37           ldi16	r2, 0x3788
 f0 03 00              ldi8	r3, 0x0
 c1 18                 ldi8	r5, 0x18
 c4 7f ff              ldi16	r4, 0xff7f
 0b                    mov	r6, r7
 d7 1f                 sys	draw_sprite_plus_mask
 c6 1e 5c              ldi16	r6, 0x5c1e
 c3 00                 ldi8	r7, 0x0
 f1 77                 zext8	r7
 f1 21                 mov	r4, r1
 f1 24                 mov	r5, r0
