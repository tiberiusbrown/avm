...
00001128 l     O .rodata	00000004 p_cat
0000112c l     O .rodata	00000007 p_abcdef
00001133 l     O .rodata	00000004 p_dog
00001137 l     O .rodata	00000008 p_ignored
00000100 l     O .data	0000000c .L__const.avm_test_main.full
0000010c l     O .data	0000000c .L__const.avm_test_main.cut
0000113f l     O .rodata	00000005 p_wood
00001144 l     O .rodata	00000007 p_flower
0000114b l     O .rodata	00000005 p_berg
00001150 l     O .rodata	00000001 p_empty
00001151 l     O .rodata	00000003 p_go
00000118 l     O .data	00000107 avm_test_main.long_pad
00001154 l     O .rodata	00000002 p_z
...
00000430 g     F .text	00000cf6 avm_test_main
00001126 g     F .text	00000002 avm_halt
...
<avm_test_main>:
 ...
 f0 1c b1              ldsp8u	r4, [sp+0xb1]
 f0 3c 20              stsp16	[sp+0x20], r4
 f0 1c b0              ldsp8u	r4, [sp+0xb0]
 ...
 18                    add	r6, r4
 f5 2c                 cmp	r7, r0
 d1 ec                 brne8	avm_test_main+638
 1c                    add	r7, r4
 f0 3f 6a              stsp16	[sp+0x6a], r7
 c6 2b 6d              ldi16	r6, 0x6d2b
 c7 f2 ff              ldi16	r7, 0xfff2
 f0 03 0e              ldi8	r3, 0xe
 f0 12 98              leasp	r2, 0x98
 ...
 f4 b4                 dec16	r4
 f6 2c                 tst16	r4
 d1 f0                 brne8	avm_test_main+2812
 c0 09                 ldi8	r4, 0x9
 ...
 f4 b4                 dec16	r4
 f5 13                 cmp	r2, r3
 d1 06                 brne8	avm_test_main+2910
 f9 a0                 and	r5, r0
 f4 a5                 tst8	r5
 d1 eb                 brne8	avm_test_main+2889
 c0 01                 ldi8	r4, 0x1
 f0 37 7e              ldsp16	r7, [sp+0x7e]
 f1 77                 zext8	r7
 c1 a5                 ldi8	r5, 0xa5
 ...
 f8 05                 cset.eq	r5
 f5 13                 cmp	r2, r3
 db 7e 01              brne16	avm_test_main+3309
 ...
 f4 b6                 dec16	r6
 f5 15                 cmp	r2, r5
 d1 06                 brne8	avm_test_main+2965
 f9 04                 and	r0, r1
 f4 a0                 tst8	r0
 d1 eb                 brne8	avm_test_main+2944
 f5 15                 cmp	r2, r5
 db 53 01              brne16	avm_test_main+3309
 c2 05                 ldi8	r6, 0x5
 ...
 f4 b6                 dec16	r6
 f5 02                 cmp	r0, r2
 d1 05                 brne8	avm_test_main+3002
 87                    and	r5, r7
 f4 a5                 tst8	r5
 d1 eb                 brne8	avm_test_main+2981
 f5 02                 cmp	r0, r2
 db 2e 01              brne16	avm_test_main+3309
 ...
 d1 05                 brne8	avm_test_main+3033
 8e                    and	r7, r6
 f4 a7                 tst8	r7
 d1 ed                 brne8	avm_test_main+3014
 f0 1d a4              ldsp8u	r5, [sp+0xa4]
 f0 0c 3c              cmpi.s8	r0, 0x3c
 db 0b 01              brne16	avm_test_main+3309
 f1 75                 zext8	r5
 cd 72                 cmpi.s8	r5, 0x72
 db 04 01              brne16	avm_test_main+3309
 c3 72                 ldi8	r7, 0x72
 c5 45 03              ldi16	r5, 0x345
 f0 11 a4              leasp	r1, 0xa4
 f4 a7                 tst8	r7
 d0 12                 breq8	avm_test_main+3079
 f7 08                 ld8u	r0, [r5+]
 f1 29                 mov	r6, r1
 f4 ae                 inc16	r6
 ...
 f5 2c                 cmp	r7, r0
 f1 0e                 mov	r1, r6
 d0 ed                 breq8	avm_test_main+3057
 e0 e6 00              jmp16	avm_test_main+3309
 f0 1d 98              ldsp8u	r5, [sp+0x98]
 cd 73                 cmpi.s8	r5, 0x73
 db de 00              brne16	avm_test_main+3309
 c3 73                 ldi8	r7, 0x73
 c5 4d 03              ldi16	r5, 0x34d
 f0 11 98              leasp	r1, 0x98
 f4 a7                 tst8	r7
 d0 12                 breq8	avm_test_main+3117
 f7 08                 ld8u	r0, [r5+]
 f1 29                 mov	r6, r1
 f4 ae                 inc16	r6
 ed e2 21              ld8u	r7, [r1+1]
 f5 2c                 cmp	r7, r0
 f1 0e                 mov	r1, r6
 d0 ed                 breq8	avm_test_main+3095
 e0 c0 00              jmp16	avm_test_main+3309
 f0 1d 90              ldsp8u	r5, [sp+0x90]
 cd 69                 cmpi.s8	r5, 0x69
 db b8 00              brne16	avm_test_main+3309
 c3 69                 ldi8	r7, 0x69
 c5 54 03              ldi16	r5, 0x354
 f0 11 90              leasp	r1, 0x90
 f4 a7                 tst8	r7
 d0 12                 breq8	avm_test_main+3155
 f7 08                 ld8u	r0, [r5+]
 f1 29                 mov	r6, r1
 f4 ae                 inc16	r6
 ed e2 21              ld8u	r7, [r1+1]
 f5 2c                 cmp	r7, r0
 f1 0e                 mov	r1, r6
 d0 ed                 breq8	avm_test_main+3133
 e0 9a 00              jmp16	avm_test_main+3309
 f0 1d 88              ldsp8u	r5, [sp+0x88]
 cd 6f                 cmpi.s8	r5, 0x6f
 db 92 00              brne16	avm_test_main+3309
 c3 6f                 ldi8	r7, 0x6f
 c5 58 03              ldi16	r5, 0x358
 f0 11 88              leasp	r1, 0x88
 f4 a7                 tst8	r7
 d0 11                 breq8	avm_test_main+3192
 f7 08                 ld8u	r0, [r5+]
 f1 29                 mov	r6, r1
 f4 ae                 inc16	r6
 ed e2 21              ld8u	r7, [r1+1]
 ...
 f5 28                 cmp	r6, r0
 0d                    mov	r7, r5
 d0 ef                 breq8	avm_test_main+3215
 a0                    xor	r4, r4
 04                    mov	r5, r4
 d4 03                 jmp8	avm_test_main+3239
 f0 35 70              ldsp16	r5, [sp+0x70]
 c0 01                 ldi8	r4, 0x1
 a1                    xor	r4, r5
