...
00000218 <avm_test_main>:
     ...
     523: c0 83        ldi8	r4, 0x83
     525: e0 5f fd     jmp16	-673
     528: c0 8d        ldi8	r4, 0x8d
     52a: e0 5a fd     jmp16	-678
     52d: c0 94        ldi8	r4, 0x94
